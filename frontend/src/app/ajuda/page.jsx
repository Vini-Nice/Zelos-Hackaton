    ...
    <DashboardLayout>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Ajuda</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {topicos.map(({ id, titulo, descricao, icone }) => (
            <div
              key={id}
              className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition cursor-pointer"
            >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          ...
          <ul className="space-y-3">
            <li className="p-3 border-b border-gray-200 dark:border-gray-700">
              <p className="font-medium text-gray-900 dark:text-gray-100">Como redefinir minha senha?</p>
              <p className="text-sm text-gray-600 dark:text-gray-300">Acesse seu perfil e clique em "Redefinir senha".</p>
            </li>
            <li className="p-3 border-b border-gray-200 dark:border-gray-700">
              <p className="font-medium text-gray-900 dark:text-gray-100">Como abrir um chamado urgente?</p>
              <p className="text-sm text-gray-600 dark:text-gray-300">Selecione prioridade alta ao criar o chamado.</p>
            </li>
            <li className="p-3 border-b border-gray-200 dark:border-gray-700">
              <p className="font-medium text-gray-900 dark:text-gray-100">Posso alterar meus dados pessoais?</p>
              <p className="text-sm text-gray-600 dark:text-gray-300">Sim, vá até a seção "Meu Perfil" para editar suas informações.</p>
            </li>
          </ul>
        </div>
        </div>
